          ...
          <TabsContent value="info">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Ingresa los datos básicos del proyecto de investigación</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="title">Título del Proyecto</Label>
                  <Input id="title" placeholder="Ingresa el título del proyecto" required />
                </div>
          ...
          <TabsContent value="team">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Agrega los estudiantes que participarán en el proyecto</CardDescription>
              </CardHeader>
              <CardContent>
                <TeamMembersForm />
              </CardContent>
          ...
          <TabsContent value="schedule">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Define las actividades y fechas del proyecto</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
          ...
          <TabsContent value="budget">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Detalla los recursos necesarios para el proyecto</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="total-budget">Presupuesto Total</Label>
                  <Input id="total-budget" type="number" placeholder="0.00" required />
                </div>
